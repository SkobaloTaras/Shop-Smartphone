...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/measuringSystem" method="GET" modelAttribute="filter">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/measuringSystem" method="POST" modelAttribute="measuringSystem">
					<div class="form-group">
						<label class="col-sm-10 col-sm-offset-2 control-label" for="unitsOfMeasurement" style="color:red;text-align:left;"><form:errors path="unitsOfMeasurement"/></label>
					</div>
					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="measuringSystem">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/measuringSystem/update/${measuringSystem.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/measuringSystem/delete/${measuringSystem.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<custom:sort innerHtml="unitsOfMeasurement asc" paramValue="unitsOfMeasurement" />
								<custom:sort innerHtml="unitsOfMeasurement desc" paramValue="unitsOfMeasurement,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
