...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/color" method="POST"  modelAttribute="color">
					<div class="form-group">
						<label class="col-sm-10 col-sm-offset-2 control-label" for="nameOfColor" style="color:red;text-align:left;"><form:errors path="nameOfColor"/></label>
					</div>
					<div class="form-group">
						<label for="name" class="col-sm-2 control-label">Name</label>
						<div class="col-sm-10">
							<form:input  class="form-control" path="nameOfColor" id="name"/>
						</div>
					</div>
					<div class="form-group">
		...
		<c:forEach items="${page.content}" var="color">
			<div class="row">
				<div class="col-md-4 col-xs-4">${color.nameOfColor}</div>
				<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/color/update/${color.id}<custom:allParams/>">update</a>
				</div><div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/color/delete/${color.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<custom:sort innerHtml="nameOfColor asc" paramValue="nameOfColor" />
								<custom:sort innerHtml="nameOfColor desc" paramValue="nameOfColor,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
