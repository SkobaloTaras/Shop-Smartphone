	...
	<div class="col-md-7 col-xs-12">
		...
		<c:forEach items="${colors}" var="color">
			<div class="row">
				...
				<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/color/update/${color.id}">update</a>
				</div><div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/color/delete/${color.id}">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
