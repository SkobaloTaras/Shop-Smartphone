...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			...
			<c:forEach items="${countryProducings}" var="countryProducing">
				<div class="row">
					<div class="col-md-4 col-xs-4">${countryProducing.nameOfCountry}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/countryProducing/update/${countryProducing.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/countryProducing/delete/${countryProducing.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
