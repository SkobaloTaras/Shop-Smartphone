...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/countryProducing" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/countryProducing" method="POST" modelAttribute="countryProducing">
					...
					<div class="form-group">
    					...
    					<div class="col-sm-10">
      						<form:input  class="form-control" path="nameOfCountry" id="name"/>
    					</div>
  					</div>
  					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="countryProducing">
				<div class="row">
					<div class="col-md-4 col-xs-4">${countryProducing.nameOfCountry}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/countryProducing/update/${countryProducing.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/countryProducing/delete/${countryProducing.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
					...
					<div class="col-md-6 col-xs-6 text-center">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<custom:sort innerHtml="nameOfCountry asc" paramValue="nameOfCountry" />
								<custom:sort innerHtml="nameOfCountry desc" paramValue="nameOfCountry,desc" />
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-xs-6 text-center">
