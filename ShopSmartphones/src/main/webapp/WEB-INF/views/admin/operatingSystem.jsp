		...
		<div class="row">
			...
			<c:forEach items="${operatingSystems}" var="operatingSystem">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/operatingSystem/update/${operatingSystem.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/operatingSystem/delete/${operatingSystem.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
